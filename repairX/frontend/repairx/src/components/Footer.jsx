    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto flex flex-wrap justify-between ml-10">
        ...
        <div className="w-full md:w-1/3">
          ...
          <p>Email: <a href="mailto:info@example.com" className="hover:underline">mdwajid@example.com</a></p>
          <p>Phone: <a href="tel:+1234567890" className="hover:underline">9717145898</a></p>
        </div>
      </div>
